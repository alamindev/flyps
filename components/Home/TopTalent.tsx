...
export default function TopTalent() {
  return (
    <section className="  py-8 max-sm:bg-brand-blue-50 space-y-7 sm:space-y-10">
      <div className="px-4">
      ...
      <div className="px-4 bg-brand-blue-50 sm:py-12">
        <div className="max-w-screen-md lg:max-w-screen-xl mx-auto ">
          <div className="max-lg:mx-auto max-lg:max-w-[500px] grid grid-cols-1 sm:grid-cols-2 max-lg:gap-y-7 lg:grid-cols-4 lg:divide-x divide-brand-primary">
            <div className="space-y-3 lg:px-3 xl:px-8 first:pl-0 pt-1 last:pr-0">
            ...
            <div className="space-y-7 lg:px-3 xl:px-8 first:pl-0 pt-1 last:pr-0">
              <div className="max-sm:max-w-[250px] mx-auto">
                <h3 className="text-[28px] max-sm:text-center font-bold text-brand-primary !leading-[1.4]">
                  Always open for
                </h3>
