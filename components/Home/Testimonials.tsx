    ...
    <section className="px-4 py-12 md:py-24   lg:py-32">
      <div className="max-w-screen-md lg:max-w-screen-xl mx-auto space-y-8 md:space-y-12 lg:space-y-24">
        <div className="flex flex-col-reverse gap-6 lg:flex-row lg:justify-between items-center">
          <div className="lg:w-56  flex gap-1 sm:gap-2 items-center">
            <Image
              alt="bg"
          ...
          <div className="lg:w-56 hidden lg:flex justify-end">
            <Link
              href="#"
          ...
          <div className="grid grid-cols-1 gap-12">
            <div className="flex gap-8">
              <div className="hidden sm:block w-[97px] shrink-0 space-y-3">
                ...
                <div className="pt-0.5 border-t border-brand-gray-50">
              ...
              <div className="space-y-6 sm:space-y-5 w-full">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Link
                    href="#"
                    className="inline-block px-4 sm:px-7 py-0.5 text-brand-primary rounded-full hover:text-white hover:bg-brand-primary transition-all duration-200 border border-brand-primary text-xs font-medium "
                  >
                    BioTech
                  </Link>
                </div>
